        ...
        <div>
            ...
            <form action="" method="POST">
                <div>
                    ...
                    <input type="datetime-local" name="expire" value="<?= $expire?>">
                </div>
                <div>
                    <label>Tỉ lệ</label>
                    <input type="number" name="rate" min="1" max="200" step="1" value=<?= intval($rate)?>>
                </div>
                <div>
                    <button name="btn_updateEvent">Sửa sự kiện</button>
                </div>
            </form>
        </div>
